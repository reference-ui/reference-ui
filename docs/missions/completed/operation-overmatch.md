...
63–79, then Ph0 80 and oracle 81 — **81 entries**) · station/case (green
pin for HAVE/SUPERIOR) ·
...
| ATM-SITE-27 mid-array ternary | ATM-SITE-27 imported conditional → **ATM-SITE-77** `[HQ 2026-09-19]` (disk; not 42) |

`[HQ 2026-09-19]` numbering on disk: **32 → `ATM-SITE-42`** (destructure);
**55 → `ATM-SITE-77`** (imported conditional). There is no `ATM-SITE-35`
(phantom catalog cite; its content lives at 42). The 2026-09-18 table
above kept fold-table `24..27` and moved the *proposals*; the imported-
conditional proposal did not land at 42.
...
**SPEC-V2-01 — scalar const resolve — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-06` · ex-1
...
_Notes:_ foundation row; shorthand twin is SPEC-V2-36. `[HQ 2026-09-19]`
cite is `ATM-SITE-06` only — `NEO-SITE-02` proves member reads (entry 30),
not this scalar.

**SPEC-V2-02 — unmutated `let`/`var` resolve — HAVE** `[HQ 2026-09-19]` · rides `ATM-SITE-28` (controls) · ex-2
...
**SPEC-V2-03 — null/undefined members don't block — HAVE** `[HQ 2026-09-19]` · `NEO-CSS-05`, `ATM-LEAF-05` · ex-3
...
_Notes:_ `[HQ 2026-09-19]` re-cite: `NEO-CSS-05` + `ATM-LEAF-05`. `ATM-SITE-21` proves nested object ternaries (entry 16), not this strip.

**SPEC-V2-04 — scalar canonicalization + vendor names — HAVE** `[HQ 2026-09-19]` · `ATM-UNIT-02`, `NEO-PARITY P18`, `ATM-SITE-60` · ne-§4
...
**SPEC-V2-05 — value-level unwraps — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-61` · ex-15
...
**SPEC-V2-06 — call-arg unwraps — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-26` + `NEO-SITE-20` · ex-16
...
**SPEC-V2-07 — old-style `<any>` assertion — HAVE** `[HQ 2026-09-19]` · rides `ATM-SITE-26` · ex-17
...
**SPEC-V2-08 — unary `-`/`+` on numeric literals — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-30` bundle · ex-18, ex-19
...
**SPEC-V2-09 — non-foldable unary refuses — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-38` · ex-20, ex-D8(`typeof` part)
...
**SPEC-V2-10 — string concat / coercion folds — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-33` + `NEO-SITE-25` · ex-21
...
**SPEC-V2-11 — numeric arithmetic + NaN/∞ drop — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-33` + `NEO-SITE-25` · ex-22, ex-23
...
**SPEC-V2-12 — equality / comparison as values — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-33` + `NEO-SITE-25` · ex-24
...
**SPEC-V2-13 — static backtick values — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-30` bundle · ex-25
...
**SPEC-V2-14 — value whitespace collapse — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-47` · ex-68
...
_Notes:_ `[HQ 2026-09-19]` HAVE — mop-up pin `ATM-SITE-47`. Oracle-era text follows. no collapsing anywhere in `extract/`/`resolve/`/`atom/`/`canon` — twins mint distinct classes AND distinct declarations. Dedupe gap, not a paint bug. No browser arm (paint-identical either way); class-identity asserted at the station.

### Family E — ternary / conditional

**SPEC-V2-15 — open-test ternary, both arms — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-05/17/23`, `NEO-SITE-01` (+JSX `NEO-SITE-15`), `ATM-SITE-64` · ex-30
...
**SPEC-V2-16 — ternary shapes: nested / equal / partial — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-05/21/23`, `ATM-SITE-63/64` · ex-32, ex-33, ex-34, ex-D4
...
**SPEC-V2-17 — object-valued ternary arms — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-27` · ex-35
...
**SPEC-V2-18 — logical with unresolvable / guard left — SUPERIOR** `[re-graded]` `[HQ 2026-09-19]` · `ATM-SITE-05`, `ATM-LEAF-04` · ex-27, ex-28
...
_Notes:_ our rule (walk both non-guard operands, `walk.rs:267`) vs v2's (right-operand) — same paint; ours diagnoses the dynamic side where v2 stays silent. Fail-closed-consistent. `[HQ 2026-09-19]` re-cite: `ATM-SITE-05` + `ATM-LEAF-04`. `NEO-SITE-08` proves entry-21 logical spreads, not this row.

**SPEC-V2-19 — all-literal short-circuit — HAVE** `[HQ 2026-09-19]` · rides `ATM-SITE-33` (fold bundle) + `NEO-SITE-25` · ex-29
...
**SPEC-V2-21 — dynamic spreads: skip / merge arms — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-05`, `NEO-SITE-08`, `NEO-SITE-22`, `ATM-SITE-66` · ex-38, ex-39, ex-40, ex-D5
...
_Notes:_ all-dynamic objects yield zero wants + warnings (lenient per-member, ex-D5). `[HQ 2026-09-19]` paint pin `NEO-SITE-22` and GAP-21 `ATM-SITE-66` landed.

**SPEC-V2-22 — colliding ternary-spread union — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-24` + `NEO-SITE-18` · ex-41
...
**SPEC-V2-23 — duplicate keys / multi-spread last-wins — HAVE** `[HQ 2026-09-19]` · `NEO-MERGE-01/02`, `ATM-SITE-67` · ex-43
...
**SPEC-V2-24 — nested-const spread keeps conditions — HAVE** `[HQ 2026-09-19]` · rides `ATM-SITE-29` · ex-44
...
**SPEC-V2-26 — null / dynamic array slots — HAVE** `[HQ 2026-09-19]` · `NEO-CSS-05`, `NEO-PRIM-04`, `ATM-SITE-69` · ex-46 (null/dynamic part)
...
**SPEC-V2-27 — mid-array ternary slots — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-27` · ex-47, ex-46 (elision), `css(c?a:b)` arg (`calls.rs:548` part)
...
**SPEC-V2-28 — array spreads: flatten literal, refuse dynamic — HAVE** `[re-graded]` `[HQ 2026-09-19]` · `ATM-SITE-37` + `NEO-SITE-23` · ex-48
...
**SPEC-V2-29 — call-form `css([...])` merge list — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-25` + `NEO-SITE-19` · ex-49
...
**SPEC-V2-31 — member depth — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-29` (shared) + `NEO-SITE-25` · ex-5, ex-6, ex-7
...
**SPEC-V2-32 — destructure binds — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-42` · ex-10
...
_Notes:_ `[HQ 2026-09-19]` pin is `ATM-SITE-42` on disk (destructure). Catalog once filed this under phantom `ATM-SITE-35` and assigned `ATM-SITE-42` to entry 55; 55 landed at `ATM-SITE-77`. No `ATM-SITE-35` exists. Oracle-era collector note follows. Collector matches `BindingIdentifier` only (`collect.rs:35`) — destructured names unrecorded. Grouped single row; lib/Book write zero const-destructuring-for-styles (App. C grep) so this stays low priority but IN dialect.

### Family J — const-graph (scope / shadow / chains / callforms)

**SPEC-V2-33 — param shadows of `css` — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-10`, `NEO-SITE-05`, `ATM-SITE-72` · ex-11
...
**SPEC-V2-34 — const-graph depth — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-29` (chains) + `ATM-SITE-28` (Ph3 object half) · ex-13, ex-D10, xf-R3, xf-R4
...
**SPEC-V2-35 — mutated `let` drops — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-28` · ex-D2 (mutation part)
...
_Notes:_ `[HQ 2026-09-19]` HAVE for the pinned station. Carve-out: cross-file mutation poison is name-wide — fail-closed over-drop; precision follow-up open. Ph1 mutation *wording* stays quarantined (station green; no phase may consume oracle wording). Unmutated controls are SPEC-V2-02. `[landed]` ATM-SITE-28: 7 mutated shapes drop with write-naming warnings, 4 controls resolve; poison name-wide by design in Ph1. Oracle-era text follows. Soundness bug: zero mutation tracking anywhere in `extract/` (`grep mutat` empty) — stale `'red'` emits with no diagnostic today. Fix: record `let`/`var` until an assignment, or drop them.

**SPEC-V2-81 — `delete obj.prop` tracked as a write — HAVE** `[HQ 2026-09-19]` · rides `ATM-SITE-28` (delete arm) · oracle follow-up on 35
...
_Notes:_ `[HQ 2026-09-19]` HAVE — mop-up pin `ATM-SITE-28` delete arm (`input/src/delete.ts`). Oracle-era text follows. outside the 35/02/53 contract; real soundness follow-up, fail-open today. Bare `extract()` (`extract/mod.rs:369`, empty-bag path) also never collects mutations — zero in-repo callers, latent; wire in or doc-comment before any caller appears.

**SPEC-V2-36 — micro-fold bundle — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-30` · ex-1 (shorthand), ex-60 (Ms part), ex-64 (string-head), ex-66
...
**SPEC-V2-37 — callee-identity + drop micros — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-36` · ex-12, ex-53/ex-D7, ex-62, ex-D2 (no-init), ex-D9, `missing_member` (`scope.rs:305`)
...
**SPEC-V2-38 — call discovery + multi-arg merge — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-02/04/12`, `NEO-SITE-04` (identity), `ATM-SITE-73` · ex-60 (HAVE part), ex-61, ex-63, ex-67, ne-§4 (multi-arg)
...
**SPEC-V2-39 — pure-helper folds — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-31` + `NEO-SITE-21` (paint arm) · ex-50
...
_Notes:_ `[HQ 2026-09-19]` HAVE. Carve-out **39-F3**: pure calls in const inits refuse-with-diagnostic where v2 folds; init-folding pass unbuilt. 39-F1 paint arm landed (`NEO-SITE-21`). `[re-graded]` the gate is a FENCE, not a decision. Adopt v2's `pure_fn` descriptor verbatim (`literal-evaluator.md:107-122`): arrow / `function` / IIFE lowered to a closed descriptor; every argument must fold; non-param captures must fold and are baked at lower time; lowering FAILS on async/generators, rest or destructured params, nested unknown calls, `this`, assignment, any impure form; bare uncalled function values never fold. Single-expression body is our additional tightening (v2 does not enumerate body shapes — we do, and refuse the rest; `fold/fence.rs`, §7.1). Highest-value new language and the easiest place to become an interpreter; SPEC-V2-42's per-shape refuse pins are the tripwires. (v1 folded these incidentally; v2 named the descriptor — take the descriptor, especially the refuse list.)

**SPEC-V2-40 — helper-returned computed key — HAVE** `[re-graded]` `[HQ 2026-09-19]` · rides `ATM-SITE-49` · ex-51
...
**SPEC-V2-42 — per-shape refuse pins — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-32` + `NEO-SITE-21` (impure arm) · ex-52 (pins)
...
**SPEC-V2-43 — `?.` on known objects — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-34` · ex-54
...
**SPEC-V2-44 — `?.` on unresolvable base drops — HAVE (blanket)** `[HQ 2026-09-19]` · `ATM-SITE-23` control, `ATM-DIAG-02`, `ATM-SITE-74` · ex-55
...
**SPEC-V2-45 — TS enum members fence — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-43` · ex-57
...
**SPEC-V2-46 — param type-literal fence — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-44` · ex-58
...
**SPEC-V2-47 — core `&` substitution — HAVE** `[HQ 2026-09-19]` · `NEO-COND-01/03/06/07/08/09`, `ATM-COND-02/09/10/14/20`, `ATM-UNIT-03`, `ATM-LAYER-09`, `NEO-PARITY P2`, `ATM-COND-30` · ne-§3.1, §3.3(H), §3.4(H), §3.5, §3.6, §3.7
...
**SPEC-V2-48 — pseudo-element lowering + sort — HAVE** `[HQ 2026-09-19]` · `NEO-COND-08`, `ATM-COND-09/14`, `ATM-COND-31` · ne-§3.14(H)
...
**SPEC-V2-80 — stacked pseudo-compound reorder (wrong paint) — HAVE** `[HQ 2026-09-19]` · `ATM-COND-29` · Ph0 GAP-48
...
**SPEC-V2-49 — `&:where(:has())` nested functional — HAVE** `[HQ 2026-09-19]` · `ATM-COND-22` + `NEO-COND-16` · ne-§3.10
...
**SPEC-V2-50 — cross-file const + member (via merge) — HAVE** `[HQ 2026-09-19]` · `NEO-SITE-07`, `ATM-SITE-16` · xf-R1, xf-R2
...
**SPEC-V2-51 — imported spreads pin — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-39` (was X-24) · xf-R5
...
**SPEC-V2-52 — aliased value import — HAVE** `[re-graded]` `[HQ 2026-09-19]` · `ATM-SITE-40` (was X-25) · xf-R6
...
**SPEC-V2-53 — `export let` folds — HAVE** `[re-graded]` `[HQ 2026-09-19]` · rides `ATM-SITE-28` · xf-R7
...
_Notes:_ `[HQ 2026-09-19]` HAVE (unpinned qualifier dropped). Carve-out: same name-wide poison precision as 35 — fail-closed over-drop; precision follow-up open. Ph1 mutation wording stays quarantined. Unmutated `export let`/`var` keep folding, pinned on SITE-28's cross-file arm. Oracle-era text follows. `visit_variable_declarator` has no kind check, so today we fold even MUTATED `let` — that half is the SPEC-V2-35 soundness bug and closes in Ph1 (mutation tracking).

**SPEC-V2-54 — unresolvable import drops + diagnostic — SUPERIOR** `[re-graded]` `[HQ 2026-09-19]` · `NEO-SITE-06` precedent, `ATM-SITE-75` · xf-R8
...
**SPEC-V2-55 — imported conditional both arms — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-77` (was X-27) · xf-R9
...
**SPEC-V2-57 — imported pure helpers — HAVE** `[re-graded]` `[HQ 2026-09-19]` · `ATM-SITE-31` cross-file arm · xf-F1
...
_Panda:_ (`cross_file.rs:1220`, `imported_pure_arrow_call_folds`; decl `:1262`, object-return `:1344`) `[HQ 2026-09-19]` cites kept (Ph2: 57/58 were transposed `:1344`↔`:1325`; this row owns `:1344`)
...
**SPEC-V2-58 — bare imported fn value — HAVE (trivially)** `[HQ 2026-09-19]` · collector behavior, `ATM-SITE-75` twin · xf-F2
_Language:_ uncalled imported function values fold nowhere.
_Ours:_ `css({ color: getColor })` (imported, uncalled) → warns, skips
_Panda:_ (`cross_file.rs:1310`, `bare_imported_function_value_does_not_fold`; aliased-export twin `:1325`) `[HQ 2026-09-19]` cites kept (this row owns `:1325`, not 57's `:1344`)

**SPEC-V2-59 — import identity scan — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-15`, `NEO-SITE-04`, `ATM-SITE-76` · xf-I1, ex-61
...
**SPEC-V2-61 — `token()` / `token.var()` surface, our evaluation — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-45` · xf-TOKEN-CALL (accept side)
...
**SPEC-V2-62 — factory consts resolve — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-46` · xf-K1 (fold part)
...
_Panda:_ (`cross_file.rs:1437`, `imported_keyframes_const_folds_in_animation_name`; positionTry `:1460`, prefix `:1506`, barrel `:1526`, alias `:1550`, multi `:1571`, joint `:1598`, viewTransition-as-value `:1481`)
_Notes:_ `[re-graded]` no ruling pending: a factory const is const-resolution LANGUAGE (the identifier resolves to the factory's name string), so it rides the const graph (SPEC-V2-34) and the binding resolver (SPEC-V2-76). `[HQ 2026-09-19]` `viewTransition()`-as-value refuses WITH diagnostic (`ATM-SITE-46`). Product codegen for these factories is OUT-OF-AXIS (§4).
...
previous draft. IDs 63–79 are Family Q; they are not the catalog total.
Ph0 80 and oracle 81 sit outside this family. Catalog total is **81**.
Each is re-graded with the mechanism that makes us equal-or-better; none
is refused on the grounds that we do less. The old rationales are quoted
where they were load-bearing, then answered.

**SPEC-V2-63 — element access with a foldable index — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-48` + `NEO-SITE-23` · ex-8, ex-56 (was differ #1, reads; SITE O1/O2/O3)
...
**SPEC-V2-64 — computed style-object keys — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-49` · ex-9 (was differ #1, keys; SITE O4)
...
**SPEC-V2-65 — non-object `css()` args: whole-object, member, wrapped, unresolvable — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-50` + `NEO-SITE-24` · App. A whole-object verdicts, `calls.rs:548` ident/member part, `:1719` (was differ #3; SITE "silent 0/0/0/0")
...
**SPEC-V2-66 — literal-test dead-arm fold — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-33` + `NEO-SITE-25` · ex-31, ex-42 (was differ #2 / D11's literal half)
...
**SPEC-V2-67 — interpolated templates over foldable parts — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-51` + `NEO-SITE-26` · ex-26 (was O8 refusal / §3B absence)
...
**SPEC-V2-68 — nesting: bare comma members scope to the parent — HAVE** `[HQ 2026-09-19]` · `ATM-COND-23` + `NEO-COND-17` · ne-§3B `:642`, `:653`, `:664`
...
**SPEC-V2-69 — nesting: `:is()` armour for complex parents — HAVE** `[HQ 2026-09-19]` · `ATM-COND-24` · ne-§3B `:675`, `:686` (and every multi-`&` / non-leading-`&` shape under a stacked parent)
...
**SPEC-V2-70 — nesting: self-`&` inside functional pseudos — HAVE** `[HQ 2026-09-19]` · `ATM-COND-25` · ne-§3B `:169`, `:224`, `:301`, `:312`, `:334`, `:356`, `:411`, `:422`
...
_Notes:_ `[HQ 2026-09-19]` spelling-sensitive — station text governs. Pin at one level; under a complex parent these ride SPEC-V2-69's armour (each `&` → `:is(parent)`). The class-name segment must be identical however the same key is spelled (canonical template, §7.5).

**SPEC-V2-71 — nesting: compound and multi-`&` — HAVE** `[HQ 2026-09-19]` · `ATM-COND-26` · ne-§3B `:235`, `:257`, `:268`, `:323`, `:345`, `:367`, `:400`
...
**SPEC-V2-72 — nesting: tag / class / BEM compounds, ancestors, tails, bare `&` — HAVE** `[HQ 2026-09-19]` · `ATM-COND-27` · ne-§3B `:48`, `:59`, `:103`, `:279`, `:290`, `:378`, `:532`, `:587`, `:598`, `:609`, `:620`, `:631`
...
_Notes:_ `[HQ 2026-09-19]` v2 `:631` mints WITH segment — station text governs (catalog previously mischaracterized the bare-`&` decision). Several of these are absurd authoring; they are pinned because the grammar must be TOTAL, not because anyone should write `&html`.

**SPEC-V2-73 — nesting: pseudo-element placements and combinator stacks — HAVE** `[HQ 2026-09-19]` · `ATM-COND-28` · ne-§3B `:444`, `:488`, `:499`, `:510`, `:543`, `:554`, `:565`
...
**SPEC-V2-74 — shadow pins: JSX tag shadowed by a param; `undefined` shadowed by a param — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-52` · ex-14, ex-D11 (was §3B "absurd code")
...
**SPEC-V2-75 — scope-aware identifier resolution — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-53` + `NEO-SITE-27` · App. B4, xf-R3/R4 root
...
**SPEC-V2-76 — binding-aware import resolution — HAVE** `[HQ 2026-09-19]` · `ATM-SITE-54/40/41/55` + `NEO-SITE-28` · xf-R6, xf-X1, xf-C1/C2/C6, xf-F1, `importMap` (was §3A "no resolver exists")
...
**SPEC-V2-78 — unary on const-resolved operands (sign preservation) — HAVE** `[HQ 2026-09-19]` · rides `ATM-SITE-38` · ex-18/19 const arm
...
**SPEC-V2-79 — numeric-string canonicalization — HAVE** `[HQ 2026-09-19]` · `ATM-UNIT-02` extension · `atomic.rs:239-261` (was §3A "approved divergence")
...
|---|---|---|---|---|
| S1 | `css(cond ? a : b)` | drops the call (`calls.rs:556`, `calls: []`) | extracts both arms | 27 · `ATM-SITE-27` `[HQ 2026-09-19]` (SPEC text names S1; SITE-05 is related conditional machinery) |
| S2 | `dyn && 'red'`, `'red' && dyn` | resolves the right operand, silent on the dropped left | resolves the static operand, diagnoses the dynamic one | 18 · `ATM-SITE-05` (+ `ATM-LEAF-04`; `NEO-SITE-08` is entry 21) |
...
| S6 | unresolvable import / missing export | drops silently (`cross_file.rs:465`, `:488`) | located diagnostic | 54 · `NEO-SITE-06` + `ATM-SITE-75` |
...
| S10 | mutated `let` then extraction | drops the identifier silently (`literal-evaluator.md:79`) | diagnostic naming the mutation site | 35 · `ATM-SITE-28` (wording/precision carve-outs stay open; station green) |
| S11 | `token('colors.red')` | parse-time hex, frozen under theme switch | `var(--colors-red)` — correct after a theme change | 61 · `ATM-SITE-45` |
| S12 | site identity through a consumer re-export | requires `importMap` config | follows the binding, zero config | 76 rider · `ATM-SITE-55` + `NEO-SITE-28` |
| S13 | namespace / default VALUE imports | refuses (`cross-file-resolution.md:95-96`) | **DEFERRED with cause** — needs export value tables; no station, not claimed | 76 rider |
| S14 | JSX tag that is a param | (no JSX shadow test in v2; v1 corpus) | fail-closed (silent skip pinned per §1-74) | 74 · `ATM-SITE-52` |
...
| S17 | `&`-less comma member under nesting | scopes to parent (parity) | scopes to parent AND stays one atom per condition (v2 emits one rule per selector) | 68 · `ATM-COND-23` + `NEO-COND-17` |
...
`[HQ 2026-09-19]` Ph1–Ph5 landed; tables below are the historical
work-order. Catalog statuses live in §1; pins in
`packages/reference-neo/docs/evidence/overmatch-ledger.md`.
...
background). **Spec count (2026-09-18 snapshot): 79 entries** — 62 from
the 2026-09-18 catalog (25 HAVE / 37 TO-BUILD then) + 17 Family Q. After
re-grade, by header status: **28 HAVE** (6 unpinned: 53, 70, 71, 72, 73,
74), **2 SUPERIOR** (18, 54; 17 is a candidate pending its station, S3),
**48 TO-BUILD**, and **1 split** (64: HAVE static / TO-BUILD folded) = 79.
That snapshot is dated. `[HQ 2026-09-19]` **Spec count: 81 entries**
(01–62 + Family Q 63–79 + Ph0 80 stacked-pseudo `ATM-COND-29` + oracle 81
`delete` as write `ATM-SITE-28` delete arm). By header: **79 HAVE** +
**2 SUPERIOR** (18, 54) = 81; **0 TO-BUILD**. Four HAVE rows carry stated
carve-outs (35/53 poison precision + Ph1 mutation wording, 39-F3, 55/76
doom seed 1). `EQUIVALENT` is carried as a sub-verdict inside 61 (the hex
fold) and 74 (the `undefined` half); no whole entry carries it. Historical
TO-BUILD-by-phase arithmetic (Ph1 12 · Ph2 13 · Ph3 21 · Ph4 3 = 49 = 48
+ the split) is the 2026-09-18 work-order, not the current header count.
**Zero absences. Zero differs. Zero blocked.** Open items are the ledger
§5 list, not missing catalog rows.
...
amendments, **applied 2026-09-19** — historical quote kept): promote 02,
06, 07, 08, 09, 13, 17, 22, 27, 28-half, 29, 35, 36, 37, 42 to HAVE;
drop unpinned qualifiers 49/51/53; re-cite 03 → LEAF-05 + positional
note, 18 + LEAF-04 − NEO-SITE-08, 38 + SITE-73, 44 + SITE-74; fix cites
57/58/62; amend the 70 note to spelling-sensitive and the 72 note (v2
`:631` mints WITH segment). 28-half is now whole (Ph3 flatten landed).
`[HQ 2026-09-19]` paperwork: catalog statuses, cites, IDs, and counts
now match `packages/reference-neo/docs/evidence/overmatch-ledger.md`.
