...
test.describe('T17 — diamond base, mixed branch composition', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/')
  })

  test('renders the chain-t17 root', async ({ page }) => {
    await expect(page.getByTestId('chain-t17-root')).toBeVisible()
  })
