# Install Matrix Scenario

This package is the thinnest downstream-style scenario for the future pipeline matrix.
...
TypeScript-specific generated surface checks now live in `matrix/typescript`.