...
export type DocsReferenceComposedButtonProps =
  DocsReferenceButtonProps & DocsReferencePressableProps
...
export interface DocsReferenceButtonProps {
   ...
   */
  onPress?: (
    event: DocsReferencePressEvent,
    state: DocsReferenceButtonState,
  ) => void
