...
const RULES: Rule[] = [
  ...
  { phase: 'assembly', match: (symbol) => !symbol.includes('ladder::') && has(symbol, 'assembly::', 'AssembleCtx', 'build_atom_set', 'resolve::', 'AtomSet', 'recipes::compile', 'push_rule', 'static_css', 'check_container_root') },
