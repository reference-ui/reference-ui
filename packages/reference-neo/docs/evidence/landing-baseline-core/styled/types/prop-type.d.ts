...
export interface UtilityValues {
	...
	outlineWidth: Tokens["spacing"] | CssProperties["outlineWidth"];
	...
	textDecorationThickness: Tokens["spacing"] | CssProperties["textDecorationThickness"];
	textUnderlineOffset: Tokens["spacing"] | CssProperties["textUnderlineOffset"];
	...
	borderRadius: Tokens["radii"] | CssProperties["borderRadius"];
	borderTopLeftRadius: Tokens["radii"] | CssProperties["borderTopLeftRadius"];
	borderTopRightRadius: Tokens["radii"] | CssProperties["borderTopRightRadius"];
	borderBottomRightRadius: Tokens["radii"] | CssProperties["borderBottomRightRadius"];
	borderBottomLeftRadius: Tokens["radii"] | CssProperties["borderBottomLeftRadius"];
	borderTopRadius: Tokens["radii"] | CssProperties["borderTopLeftRadius"];
	borderRightRadius: Tokens["radii"] | CssProperties["borderTopRightRadius"];
	borderBottomRadius: Tokens["radii"] | CssProperties["borderBottomLeftRadius"];
	borderLeftRadius: Tokens["radii"] | CssProperties["borderTopLeftRadius"];
	borderStartStartRadius: Tokens["radii"] | CssProperties["borderStartStartRadius"];
	borderStartEndRadius: Tokens["radii"] | CssProperties["borderStartEndRadius"];
	borderStartRadius: Tokens["radii"] | CssProperties["borderStartStartRadius"];
	borderEndStartRadius: Tokens["radii"] | CssProperties["borderEndStartRadius"];
	borderEndEndRadius: Tokens["radii"] | CssProperties["borderEndEndRadius"];
	borderEndRadius: Tokens["radii"] | CssProperties["borderStartEndRadius"];
	borderWidth: Tokens["spacing"] | CssProperties["borderWidth"];
	borderTopWidth: Tokens["spacing"] | CssProperties["borderTopWidth"];
	borderLeftWidth: Tokens["spacing"] | CssProperties["borderLeftWidth"];
	borderRightWidth: Tokens["spacing"] | CssProperties["borderRightWidth"];
	borderBottomWidth: Tokens["spacing"] | CssProperties["borderBottomWidth"];
	borderBlockStartWidth: Tokens["spacing"] | CssProperties["borderBlockStartWidth"];
	borderBlockEndWidth: Tokens["spacing"] | CssProperties["borderBlockEndWidth"];
	borderColor: Tokens["colors"];
	borderInlineWidth: Tokens["spacing"] | CssProperties["borderInlineWidth"];
	borderInlineColor: Tokens["colors"];
	borderBlockWidth: Tokens["spacing"] | CssProperties["borderBlockWidth"];
	borderBlockColor: Tokens["colors"];
	borderLeftColor: Tokens["colors"];
	borderInlineStartWidth: Tokens["spacing"] | CssProperties["borderInlineStartWidth"];
	borderInlineStartColor: Tokens["colors"];
	borderRightColor: Tokens["colors"];
	borderInlineEndWidth: Tokens["spacing"] | CssProperties["borderInlineEndWidth"];
	...
	animationName: "ping" | "flash" | "glow" | "shimmer" | "bounce" | "bounceIn" | "bounceOut" | "shake" | "fadeIn" | "fadeOut" | "fadeInUp" | "fadeInDown" | "fadeInLeft" | "fadeInRight" | "scaleIn" | "scaleOut" | "scaleUp" | "scaleDown" | "pulse" | "heartbeat" | "slideUp" | "slideDown" | "slideLeft" | "slideRight" | "slideUpOut" | "slideDownOut" | "spin" | "spinReverse" | "rotate90" | "rotate180" | "wigglewiggle";
	...
	size: Tokens["spacing"] | CssProperties["size"];
	colorPalette: "slate" | "gray" | "red" | "orange" | "amber" | "yellow" | "lime" | "green" | "emerald" | "teal" | "cyan" | "sky" | "blue" | "indigo" | "violet" | "purple" | "magenta" | "pink" | "rose" | "text" | "design" | "design.primary" | "design.primary.hover" | "design.accent" | "design.text" | "design.mark" | "reference" | "ui" | "ui.selection" | "ui.dialog" | "ui.hr" | "ui.meta" | "ui.blockquote" | "ui.cite" | "ui.small" | "ui.code" | "ui.code.inline" | "ui.kbd" | "ui.pre" | "ui.samp" | "ui.link" | "ui.mark" | "ui.ins" | "ui.abbr" | "ui.del" | "ui.dfn" | "ui.q" | "ui.s" | "ui.u" | "ui.varTag" | "ui.list" | "ui.list.marker" | "ui.list.definition" | "ui.list.definition.description" | "ui.fieldset" | "ui.label" | "ui.field" | "ui.checkbox" | "ui.checkbox.unchecked" | "ui.checkbox.checked" | "ui.checkbox.tick" | "ui.radio" | "ui.radio.track" | "ui.radio.checked" | "ui.radio.checked.inner" | "ui.radio.checked.ring" | "ui.button" | "ui.button.disabled" | "ui.progress" | "ui.progress.bar" | "ui.progress.track" | "ui.meter" | "ui.meter.optimum" | "ui.meter.suboptimum" | "ui.meter.evenLessGood" | "ui.focus" | "ui.table" | "ui.table.row" | "ui.table.footer" | "ui.table.cell" | "ui.table.caption" | "ui.media" | "ui.media.caption" | "ui.media.embed" | "ui.disclosure" | "ui.tab" | "ui.tab.track";
}
