// Unit tests for the Neo font() collector plus file collection.
// They take font options and fixture files and assert collected definitions.
// This file is a Neo-owned copy of the core font tests.
