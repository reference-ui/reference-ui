// Unit tests for the Neo tokens() collector plus file collection.
// They take token trees and fixture files and assert collected fragments.
// This file is a Neo-owned copy of the core tokens tests.

import { describe, expect, it, afterEach } from 'vitest'
import { mkdirSync, rmSync, writeFileSync } from 'node:fs'
import { join } from 'node:path'
import { tokens, createTokensCollector } from './tokens.ts'
