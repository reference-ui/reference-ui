// Unit tests for the Neo keyframes() collector plus file collection.
// They take keyframe maps and fixture files and assert collected fragments.
// This file is a Neo-owned copy of the core keyframes tests.
