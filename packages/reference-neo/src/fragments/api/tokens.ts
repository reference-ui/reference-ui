// Author tokens() call plus its fragment collector.
// It takes token trees from fragment files and emits collected configs.
// This module is a Neo-owned copy of the core tokens collector.
...
/**
 * Register design tokens for the system spec.
 ...
 * `extends`, and are hidden from the token surface.
 *
 * @example
 * ```ts
 * tokens({
...
/** Used by the sync runner to collect token fragments when running fragment files. */
