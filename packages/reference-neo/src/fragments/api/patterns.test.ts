// Unit tests for the Neo extendPattern() collector plus file collection.
// They take pattern extensions and fixture files and assert collected entries.
// This file is a Neo-owned copy of the core patterns tests.

import { describe, expect, it, afterEach } from 'vitest'
import { mkdirSync, rmSync, writeFileSync } from 'node:fs'
import { join } from 'node:path'
import { extendPattern, createBoxPatternCollector } from './patterns.ts'
