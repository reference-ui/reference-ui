...
// objects before resolving classes. It takes style objects and emits lowered
// shapes. This module is a Neo-owned copy of the core responsive lowering.

type ResponsiveStyleObject = Record<string, unknown>

/**
 * Lower Reference UI-owned responsive sugar into plain container-query style
 * objects before delegating to plan resolution.
 *
 * This mirrors the build-time shape for anonymous numeric `r` breakpoints so
 * runtime css() consumers and native extraction observe the same style shape.
