// Unit tests for the Neo alias plugin over exact id matching.
// They take alias maps and assert resolve filters plus target paths.
// This file is a Neo-owned copy of the core alias plugin tests.
