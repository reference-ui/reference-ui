...
| NEO-SITE-21 | Impure-helper leaves (`Math.random`, async call) refuse while static margin siblings paint | done | ATM-SITE-32 | — | siblings paint; refused colors paint nothing; sheet carries exactly the two sibling utilities; recompile carries the two positioned warnings | `[overmatch]` SPEC-V2-42; `[panda-v2]` `scope.rs:1020`, `:1164` |
