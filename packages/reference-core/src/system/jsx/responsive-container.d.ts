...
export interface ResponsiveContainerProps extends ResponsiveContainerProperties, DistributiveOmit<HTMLStyledProps<'div'>, keyof ResponsiveContainerProperties | 'r'> {}
