...
function generatePrimitive(tag: string): string {
  ...
  return [
    ...
    `return <LayerScopeContext.Provider value={providesLayerScope}><ColorModeContext.Provider value={resolvedColorMode}><${tag} ref={ref} className={classes} {...dataLayerAttr} {...colorModeAttr} {...variantAttr} {...elementProps}>{children}</${tag}></ColorModeContext.Provider></LayerScopeContext.Provider>; `,
    `}); `,
