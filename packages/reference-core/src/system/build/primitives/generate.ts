...
function generatePrimitive(tag: string): string {
  ...
  return [
    ...
    `const colorModeAttr = colorMode != null && colorMode !== '' ? { 'data-panda-theme': String(colorMode) } : {}; `,
    `return <${tag} ref={ref} className={classes} {...dataLayerAttr} {...colorModeAttr} {...elementProps}>{children}</${tag}>; `,
    `}); `,
