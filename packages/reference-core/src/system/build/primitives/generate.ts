...
function generatePrimitive(tag: string): string {
  ...
  return [
    ...
    `const { className, children, styleProps, elementProps } = splitPrimitiveProps(typedProps); `,
    ...
    `return <${tag} ref={ref} className={classes} {...dataLayerAttr} {...elementProps}>{children}</${tag}>; `,
    `}); `,
...
function generateFile(tags: string[], generatorPath: string): string {
  ...
  const lines = [
    ...
    "  return { className, children, styleProps, elementProps }",
    "}",
    '',
