...
function generatePrimitive(tag: string): string {
  ...
  return [
    ...
    `const { className, children, layer, styleProps, elementProps } = splitPrimitiveProps(typedProps); `,
...
function generateFile(tags: string[], generatorPath: string): string {
  ...
  const lines = [
    ...
    "  const { className, children, layer, ...rest } = props as T & {",
    "    className?: string",
    "    children?: React.ReactNode",
    "    layer?: string",
    "  }",
    "  const [styleProps, elementProps] = splitCssProps(rest)",
    "  return { className, children, layer, styleProps, elementProps }",
    "}",
    '',
