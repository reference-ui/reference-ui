...
export type BlockquoteStyleVariantProps = {
  [key in keyof BlockquoteStyleVariant]?:
    | ConditionalValue<BlockquoteStyleVariant[key]>
    | undefined
}
...
export interface BlockquoteStyleRecipe {
  ...
  splitVariantProps<Props extends BlockquoteStyleVariantProps>(
    props: Props
  ): [
    BlockquoteStyleVariantProps,
    Pretty<DistributiveOmit<Props, keyof BlockquoteStyleVariantProps>>,
  ]
