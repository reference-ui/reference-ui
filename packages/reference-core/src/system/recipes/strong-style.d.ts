...
export type StrongStyleVariantProps = {
  [key in keyof StrongStyleVariant]?:
    | ConditionalValue<StrongStyleVariant[key]>
    | undefined
}
...
export interface StrongStyleRecipe {
  ...
  splitVariantProps<Props extends StrongStyleVariantProps>(
    props: Props
  ): [
    StrongStyleVariantProps,
    Pretty<DistributiveOmit<Props, keyof StrongStyleVariantProps>>,
  ]
