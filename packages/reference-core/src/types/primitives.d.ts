...
export type PrimitiveProps<T extends PrimitiveTag> = Omit<PrimitiveNativeProps<T>, keyof PrimitiveOwnProps> & PrimitiveOwnProps;
export type PrimitiveElement<T extends PrimitiveTag> = React.ComponentRef<T>;
export type PrimitiveComponent<T extends PrimitiveTag> = React.ForwardRefExoticComponent<React.PropsWithoutRef<PrimitiveProps<T>> & React.RefAttributes<PrimitiveElement<T>>>;
export {};
