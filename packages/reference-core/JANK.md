...
This document tracks technical debt, brittle architectural patterns, and verified issues in `@reference-ui/core`. 
...
- **Location:** [`packages/reference-core/src/config/store.ts`](file:///Users/ryn/Developer/reference-ui/packages/reference-core/src/config/store.ts#L55-L60) & [`src/lib/log/index.ts`](file:///Users/ryn/Developer/reference-ui/packages/reference-core/src/lib/log/index.ts#L33-L36)
...
- **Location:** [`packages/reference-core/src/system/panda/config/run.ts#L95`](file:///Users/ryn/Developer/reference-ui/packages/reference-core/src/system/panda/config/run.ts#L95) & [`extensions/api/bundle.ts#L16-L28`](file:///Users/ryn/Developer/reference-ui/packages/reference-core/src/system/panda/config/extensions/api/bundle.ts#L16-L28)
...
These patterns represent deliberate, pragmatic platform compromises made to ship high-performance tooling without rewriting third-party libraries from scratch.
...
- **Rationale:** Piscina handles thread setup, workerData transfer, and lifecycle boilerplate out of the box. Holding tasks open avoids building a bespoke worker supervisor on raw `node:worker_threads`.
...
- **Rationale:** High-volume writes to `.reference-ui/virtual` under heavy build activity can overflow macOS kernel event buffers. Suppressing resync on dropped events prevents infinite build-trigger loops.

### 2.3 Double Component Mirroring
- **Location:** [`tools/copy-reference-api-component.mjs`](file:///Users/ryn/Developer/reference-ui/packages/reference-core/tools/copy-reference-api-component.mjs) & [`src/reference/bridge/copy-browser-virtual.ts`](file:///Users/ryn/Developer/reference-ui/packages/reference-core/src/reference/bridge/copy-browser-virtual.ts)
