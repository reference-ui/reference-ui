...
var isObjectOrArray = /* @__PURE__ */ __name(
  ...
  return walkObject(
    ...
    value => {
      return Array.isArray(value)
        ? toResponsiveObject(value, conditions2.breakpoints.keys)
        : value
    },
    {
      stop: /* @__PURE__ */ __name(value => Array.isArray(value), 'stop'),
      getKey: shorthand
        ? prop => (hasShorthand ? resolveShorthand2(prop) : prop)
        : void 0,
    }
  )
}
...
function createCss(context2) {
  ...
  const formatClassName = /* @__PURE__ */ __name(
    str => [utility.prefix, str].filter(Boolean).join('-'),
    'formatClassName'
  )
...
function splitProps(props, ...keys) {
  ...
  const fn = /* @__PURE__ */ __name(
    key => split(Array.isArray(key) ? key : dKeys.filter(key)),
    'fn'
  )
...
var resolveShorthand = /* @__PURE__ */ __name(
  prop => shorthands.get(prop) || prop,
  'resolveShorthand'
)
var context = {
  conditions: {
...
function cva(config2) {
  ...
  const getVariantProps = /* @__PURE__ */ __name(
    variants2 => ({ ...defaultVariants, ...compact(variants2) }),
    'getVariantProps'
  )
...
// ../reference-core/src/styled/rhythm/utilities.ts
var rhythmTransform = /* @__PURE__ */ __name(
  property => ({
    property,
    values: 'spacing',
...
var defaultFragments = [
  ...
  radii_exports,
  spacing_exports,
  extendGlobalCss_exports,
  extendGlobalFontface_exports,
  extendKeyframes_exports,
  extendRecipe_exports,
  extendStaticCss_exports,
  extendTokens_exports,
  extendUtilities_exports,
  internal_exports,
]
  .map(m => (m?.default !== void 0 ? m.default : null))
  .filter(Boolean)
...
export { panda_entry_default as default }
