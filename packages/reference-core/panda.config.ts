...
// ../reference-core/src/styled/deprecated-colors.ts
var deprecated_colors_exports = {};
__export(deprecated_colors_exports, {
  COLOR_PROP_KEYS: () => COLOR_PROP_KEYS,
  CSS_NAMED_COLOR_KEYS: () => CSS_NAMED_COLOR_KEYS
});
var CSS_NAMED_COLOR_KEYS = [
  "aliceblue",
  "antiquewhite",
  "aqua",
  "aquamarine",
