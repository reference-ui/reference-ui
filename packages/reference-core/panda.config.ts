...
// ../reference-core/src/cli/panda/config/createPandaConfig.ts
...
var defaultFragments = [panda_base_exports, colors_exports, font_exports, styled_exports, patterns_exports2, api_exports, patterns_exports, tokens_exports].map((m) => m && typeof m === "object" && m.default !== void 0 ? m.default : null).filter(Boolean);
