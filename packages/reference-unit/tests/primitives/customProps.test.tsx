...
describe('Font prop', () => {
  ...
  it('applies serif font preset - verifies className is set', () => {
    render(
      <Div data-testid="font-serif" font="serif">
        Serif Font
      </Div>
    )
    
    const el = screen.getByTestId('font-serif')
    expect(el).toBeInTheDocument()
    expect(el.className).toBeTruthy()
  })
  ...
  it('applies mono font preset - verifies className is set', () => {
    render(
      <Div data-testid="font-mono" font="mono">
        Mono Font
      </Div>
    )
