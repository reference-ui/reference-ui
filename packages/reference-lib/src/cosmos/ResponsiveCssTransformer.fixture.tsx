	...
	return (
		<Div padding="5r" fontFamily="reference.sans" display="grid" gap="3r">
			...
			<Div color="gray.600" maxWidth="72ch">
				...
				context, while the raw inner div and button respond through css() using `r`
				sugar that should lower into container queries in virtual-rs.
			</Div>
				...
				<div className={frameClass}>
					<div className={heroClass}>
						...
						<p className={copyClass}>
							...
							from `r` inside css() on the inner elements.
						</p>
					...
					<div className={noteClass}>
						<p className={noteTextClass}>
							This fixture isolates the path you wanted to test: `container` on Div,
