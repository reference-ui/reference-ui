...
- [ ] `RL-LIFE-02` `[convergence]` `[browser]` —
...
- [ ] `RL-LIFE-06` `[reference]` `[react:all]` —
...
- [ ] `RL-CONFIG-01` `[reference]` `[browser]` —
...
- [ ] `RL-CONFIG-02` `[reference]` `[browser]` —
  **ReferenceLibrary should apply configured toaster defaults when higher
  ...
  precedence.
- [ ] `RL-CONFIG-03` `[reference]` `[browser]` —
...
- [ ] `RL-CONFIG-04` `[reference]` `[browser]` —
...
- [ ] `RL-CONFIG-05` `[reference]` `[browser]` —
...
- [ ] `RL-CONFIG-06` `[reference]` `[browser]` —
