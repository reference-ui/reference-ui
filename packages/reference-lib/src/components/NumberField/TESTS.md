...
- [x] `NF-PARSE-01` `[convergence]` `[unit]` —
...
- [x] `NF-PARSE-04` `[convergence]` `[unit]` —
...
- [x] `NF-PARSE-05` `[convergence]` `[unit]` —
...
- [x] `NF-PARSE-09` `[convergence]` `[unit]` —
...
- [x] `NF-PARSE-12` `[convergence]` `[unit]` —
...
- [x] `NF-PARSE-14` `[convergence]` `[unit]` —
...
- [x] `NF-PARSE-17` `[convergence]` `[unit]` —
...
- [x] `NF-EDIT-01` `[reference]` `[browser]` —
...
- [x] `NF-EDIT-02` `[convergence]` `[browser]` —
...
- [x] `NF-EDIT-05` `[reference]` `[browser]` —
...
- [x] `NF-EDIT-06` `[vendor]` `[browser:all]` —
...
- [x] `NF-EDIT-09` `[convergence]` `[browser]` —
...
- [x] `NF-EDIT-10` `[reference]` `[browser]` —
...
- [x] `NF-EDIT-11` `[vendor]` `[browser:all]` —
...
- [x] `NF-EDIT-13` `[reference]` `[browser]` —
  **Consumer edit handlers should run in native order with cancellation only
  ...
  last.
- [x] `NF-EDIT-14` `[reference]` `[browser]` —
...
- [x] `NF-EDIT-15` `[vendor]` `[browser:all]` —
...
- [x] `NF-EDIT-16` `[vendor]` `[browser:all]` —
...
- [x] `NF-EDIT-17` `[reference]` `[browser]` —
...
- [x] `NF-EDIT-18` `[reference]` `[browser]` —
...
- [x] `NF-EDIT-19` `[reference]` `[browser]` —
...
- [x] `NF-COMMIT-01` `[convergence]` `[browser:all]` —
...
- [x] `NF-COMMIT-02` `[vendor]` `[browser:all]` —
...
- [x] `NF-COMMIT-03` `[convergence]` `[browser]` —
...
- [x] `NF-COMMIT-04` `[reference]` `[browser]` —
...
- [x] `NF-COMMIT-06` `[reference]` `[browser]` —
...
- [x] `NF-COMMIT-07` `[reference]` `[browser]` —
...
- [x] `NF-COMMIT-08` `[reference]` `[browser]` —
...
- [x] `NF-COMMIT-09` `[vendor]` `[browser]` —
  **A no-edit focus/blur cycle should preserve full controlled precision.**
  ...
  display.
- [x] `NF-COMMIT-10` `[reference]` `[browser]` —
...
- [x] `NF-COMMIT-11` `[reference]` `[browser]` —
...
- [x] `NF-KEY-01` `[vendor]` `[browser:all]` —
...
- [x] `NF-KEY-02` `[reference]` `[browser:all]` —
...
- [x] `NF-KEY-03` `[reference]` `[browser:all]` —
...
- [x] `NF-KEY-04` `[convergence]` `[browser]` —
...
- [x] `NF-STEP-01` `[reference]` `[browser]` —
...
- [x] `NF-STEP-02` `[vendor]` `[browser:all]` —
...
- [x] `NF-STEP-03` `[vendor]` `[browser:all]` —
...
- [x] `NF-STEP-06` `[reference]` `[browser]` —
...
- [x] `NF-STEP-07` `[reference]` `[browser]` —
  **Pointer leave should end the repeat session rather than pause it.** Leave
  ...
  no outside callback.
- [x] `NF-STEP-08` `[reference]` `[browser]` —
...
- [x] `NF-STEP-10` `[convergence]` `[touch]` —
...
- [x] `NF-STEP-13` `[reference]` `[browser]` —
...
- [x] `NF-STEP-14` `[reference]` `[browser]` —
...
- [x] `NF-FORM-01` `[convergence]` `[browser]` —
...
- [x] `NF-FORM-02` `[vendor]` `[browser:all]` —
...
- [x] `NF-FORM-03` `[reference]` `[browser]` —
...
- [x] `NF-FORM-05` `[reference]` `[browser:all]` —
...
- [x] `NF-FORM-06` `[reference]` `[browser]` —
...
- [x] `NF-FORM-07` `[reference]` `[browser]` —
...
- [x] `NF-FORM-08` `[reference]` `[browser]` —
...
- [x] `NF-FORM-09` `[convergence]` `[browser]` —
  **Autofill-equivalent input/change events should follow ordinary public edit
  ...
  claim.
- [x] `NF-FORM-10` `[reference]` `[browser]` —
...
- [x] `NF-FORM-11` `[reference]` `[browser]` —
  **Clicking submit after an incomplete or unaccepted blur commit should block
  ...
  boundary.
- [x] `NF-FORM-12` `[reference]` `[browser]` —
...
- [x] `NF-FORM-13` `[reference]` `[browser]` —
  **All dirty NumberFields should process the same submit even when it is
  ...
  escapes.
- [x] `NF-FORM-14` `[reference]` `[browser]` —
...
- [x] `NF-A11Y-01` `[convergence]` `[browser:all]` —
...
- [x] `NF-A11Y-02` `[reference]` `[browser]` —
...
- [x] `NF-A11Y-04` `[reference]` `[browser]` —
...
- [x] `NF-A11Y-05` `[reference]` `[browser]` —
...
- [x] `NF-A11Y-06` `[reference]` `[browser]` —
...
- [x] `NF-SURF-01` `[reference]` `[browser]` —
...
- [x] `NF-DYNAMIC-01` `[reference]` `[browser]` —
...
- [x] `NF-DYNAMIC-02` `[vendor]` `[browser]` —
...
- [x] `NF-DYNAMIC-03` `[reference]` `[browser]` —
...
- [x] `NF-DYNAMIC-04` `[reference]` `[browser]` —
...
- [x] `NF-DYNAMIC-05` `[reference]` `[browser]` —
...
- [x] `NF-ENV-07` `[convergence]` `[browser:all]` —
...
- [x] `NF-COMP-01` `[reference]` `[browser]` —
  **A quantity NumberField should compose integer bounds, named steppers,
  ...
  canonical payload.
- [x] `NF-COMP-02` `[reference]` `[browser]` —
...
- [x] `NF-COMP-03` `[reference]` `[browser]` —
...
- [x] `NF-MANUAL-01` `[reference]` `[manual]` `[release]` —
...
- [x] `NF-MANUAL-02` `[reference]` `[manual]` `[release]` —
...
- [x] `NF-MANUAL-03` `[reference]` `[manual]` `[release]` —
  **Real iOS and Android keyboards should expose usable characters for each
  ...
  attributes only.
- [x] `NF-MANUAL-04` `[reference]` `[manual]` `[release]` —
