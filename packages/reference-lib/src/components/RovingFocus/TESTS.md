...
- [ ] `RF-GRID-01` `[convergence]` `[browser:all]` —
  **RovingFocus should follow visual rows and columns when `orientation="both"` forms a regular grid.**
  ...
  horizontal center.
- [ ] `RF-GRID-02` `[convergence]` `[browser]` —
...
- [ ] `RF-GRID-03` `[convergence]` `[browser]` —
...
- [ ] `RF-NEST-01` `[convergence]` `[browser]` —
...
- [ ] `RF-ENV-03` `[reference]` `[browser:all]` —
...
- [ ] `RF-COMP-03` `[reference]` `[browser]` `[rtl]` —
