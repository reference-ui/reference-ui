...
- [x] `MN-FOCUS-02` `[convergence]` `[browser]` —
...
- [x] `MN-FOCUS-03` `[vendor]` `[browser:all]` —
...
- [x] `MN-FOCUS-04` `[vendor]` `[browser:all]` —
  **Horizontal Menu should rove with mirrored Left and Right while reserving cross-axis keys for submenus.**
  ...
  hierarchy semantics.
- [x] `MN-FOCUS-05` `[reference]` `[browser]` —
...
- [x] `MN-TYPE-02` `[vendor]` `[browser]` —
  **Menu should treat Space as search text rather than activation during an active typeahead buffer.**
  ...
  regression.
- [x] `MN-TYPE-03` `[reference]` `[browser]` —
  **Menu should reset and scope typeahead buffers as submenu ownership changes.**
  ...
  lifetime.
- [x] `MN-TYPE-04` `[reference]` `[browser]` —
...
- [x] `MN-ACT-01` `[vendor]` `[browser:all]` —
...
- [x] `MN-ACT-02` `[vendor]` `[browser:all]` —
...
- [x] `MN-ACT-04` `[convergence]` `[browser]` —
...
- [x] `MN-CHOICE-02` `[vendor]` `[browser:all]` —
...
- [x] `MN-CHOICE-03` `[reference]` `[browser]` —
...
- [x] `MN-CHOICE-04` `[vendor]` `[browser:all]` —
...
- [x] `MN-CHOICE-05` `[reference]` `[browser]` —
...
- [x] `MN-CHOICE-06` `[reference]` `[browser]` —
...
- [x] `MN-CHOICE-07` `[convergence]` `[browser]` —
  **Menu choice items should let cancellation stop both state requests and dismissal.**
  ...
  toggle a choice.
- [x] `MN-CHOICE-08` `[reference]` `[browser]` —
...
- [x] `MN-CHOICE-10` `[reference]` `[browser]` —
...
- [x] `MN-LINK-02` `[vendor]` `[browser:all]` —
...
- [x] `MN-LINK-03` `[vendor]` `[browser:all]` —
...
- [x] `MN-LINK-04` `[convergence]` `[browser]` —
...
- [x] `MN-LINK-05` `[vendor]` `[browser:all]` —
...
- [x] `MN-LINK-07` `[vendor]` `[browser]` —
  **Disabled Menu LinkItem should be non-navigable and absent from focus, typeahead, and dismissal paths.**
  ...
  route.
- [x] `MN-LINK-08` `[reference]` `[browser]` —
  **Menu LinkItem should preserve navigation but suppress dismissal when closeOnSelect is false.**
  ...
  policy.
- [x] `MN-LINK-09` `[reference]` `[browser]` —
...
- [x] `MN-SUBKEY-01` `[vendor]` `[browser:all]` —
...
- [x] `MN-SUBKEY-02` `[vendor]` `[browser:all]` —
  **Menu should give Enter and Space the same controlled submenu open-and-focus behavior.**
  ...
  selection.
- [x] `MN-SUBKEY-03` `[vendor]` `[browser:all]` —
...
- [x] `MN-SUBKEY-06` `[reference]` `[browser]` —
  **Menu should remain visibly controlled when submenu open or close requests are rejected.**
  ...
  changed.
- [x] `MN-SUBKEY-07` `[reference]` `[browser]` —
  **Menu should honor consumer key cancellation before submenu or roving defaults.**
  ...
  key.
- [x] `MN-SUBKEY-08` `[reference]` `[browser]` —
...
- [x] `MN-SUBKEY-09` `[reference]` `[browser]` —
...
- [x] `MN-INTENT-01` `[vendor]` `[browser:all]` —
...
- [x] `MN-INTENT-07` `[vendor]` `[rtl]` —
  **RTL Menu should mirror toward-and-away submenu intent geometry.**
  ...
  pointer matrix.
- [x] `MN-INTENT-08` `[reference]` `[touch]` —
...
- [x] `MN-INTENT-09` `[convergence]` `[unit]` —
...
- [x] `MN-INTENT-10` `[convergence]` `[browser]` —
...
- [x] `MN-CLOSE-03` `[reference]` `[browser]` —
...
- [x] `MN-CLOSE-04` `[reference]` `[browser]` —
  **Menu should cascade a programmatic root close deepest-first and restore only the root trigger.**
  ...
  restoration.
- [x] `MN-CLOSE-05` `[reference]` `[browser]` —
...
- [x] `MN-CLOSE-07` `[reference]` `[browser]` —
...
- [x] `MN-CLOSE-08` `[reference]` `[browser]` —
...
- [x] `MN-DYNAMIC-01` `[vendor]` `[browser]` —
...
- [x] `MN-DYNAMIC-02` `[reference]` `[browser]` —
...
- [x] `MN-DYNAMIC-03` `[reference]` `[browser]` —
...
- [x] `MN-DYNAMIC-04` `[vendor]` `[browser]` —
...
- [x] `MN-ENV-02` `[reference]` `[react:all]` —
...
- [x] `MN-ENV-03` `[reference]` `[shadow]` —
  **Menu should preserve composed-path ownership and submenu behavior from a ShadowRoot.**
  ...
  up correctly.
- [x] `MN-ENV-04` `[reference]` `[browser:all]` —
...
- [x] `MN-A11Y-01` `[reference]` `[browser]` —
...
- [x] `MN-COMP-01` `[reference]` `[browser]` —
...
- [x] `MN-COMP-03` `[reference]` `[browser]` `[rtl]` —
  **Nested Menu should preserve two-level keyboard, intent, collision, and RTL ownership.**
  ...
  freeze composition.
- [x] `MN-COMP-04` `[reference]` `[browser]` —
...
- [x] `MN-COMP-05` `[reference]` `[browser]` —
