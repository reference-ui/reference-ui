...
- [ ] `AC-SINGLE-02` `[convergence]` `[browser]` —
...
- [ ] `AC-SINGLE-03` `[reference]` `[browser]` —
...
- [ ] `AC-SINGLE-05` `[vendor]` `[browser]` —
  **A disabled Accordion item should not request policy changes or displace
  ...
  is disabled.”
- [ ] `AC-SINGLE-06` `[reference]` `[browser]` —
