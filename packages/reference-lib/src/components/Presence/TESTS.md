...
- [ ] `PR-INSTANT-01` `[vendor]` `[browser]` —
  **Presence should remove its child in the same committed update when no CSS effect can delay exit.**
  ...
  timer is required.
- [ ] `PR-INSTANT-02` `[convergence]` `[browser]` —
...
- [ ] `PR-INSTANT-04` `[convergence]` `[browser]` —
...
- [ ] `PR-INSTANT-05` `[reference]` `[browser]` —
...
- [ ] `PR-INSTANT-07` `[convergence]` `[browser]` —
...
- [ ] `PR-TRANSITION-01` `[convergence]` `[browser:all]` —
  **Presence should retain a closing child when its own transform transition is still running.**
  ...
  `transitionend`.
- [ ] `PR-TRANSITION-02` `[convergence]` `[browser:all]` —
...
- [ ] `PR-TRANSITION-03` `[convergence]` `[browser:all]` —
...
- [ ] `PR-TRANSITION-04` `[convergence]` `[browser]` —
  **Presence should ignore descendant transition events when it observes a transitioning parent child.**
  ...
  once.
- [ ] `PR-TRANSITION-05` `[convergence]` `[browser:all]` —
...
- [ ] `PR-TRANSITION-06` `[reference]` `[browser]` —
...
- [ ] `PR-ANIMATION-01` `[vendor]` `[browser:all]` —
...
- [ ] `PR-ANIMATION-02` `[vendor]` `[browser:all]` —
...
- [ ] `PR-ANIMATION-03` `[convergence]` `[browser]` —
...
- [ ] `PR-ANIMATION-04` `[vendor]` `[browser]` —
  **Presence should remove immediately when the animation name does not change for the closed state.**
  ...
  in the close commit.
- [ ] `PR-ANIMATION-05` `[vendor]` `[browser:all]` —
  **Presence should complete a suspended exit when the observed animation is canceled.**
  ...
  event.
- [ ] `PR-ANIMATION-06` `[convergence]` `[browser]` —
...
- [ ] `PR-ANIMATION-07` `[reference]` `[browser]` —
...
- [ ] `PR-RACE-01` `[convergence]` `[browser:all]` —
...
- [ ] `PR-RACE-03` `[vendor]` `[browser]` —
  **Presence should create a fresh completion set when a child closes again after reopening.**
  ...
  removal and cleanup.
- [ ] `PR-RACE-04` `[convergence]` `[browser]` —
...
- [ ] `PR-RACE-05` `[convergence]` `[browser]` —
...
- [ ] `PR-NEST-01` `[convergence]` `[browser:all]` —
  **Presence should keep a closing parent mounted when a descendant exit lasts longer than the parent's own effect.**
  ...
  afterward.
- [ ] `PR-NEST-02` `[convergence]` `[browser]` —
...
- [ ] `PR-NEST-04` `[reference]` `[react:all]` —
