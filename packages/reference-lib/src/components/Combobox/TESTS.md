...
- [x] `CB-OPEN-03` `[convergence]` `[browser]` —
...
- [x] `CB-OPEN-04` `[vendor]` `[browser]` —
  **Combobox should keep an open editable Input open while native Trigger activation toggles select-only state.**
  ...
  click toggle.
- [x] `CB-OPEN-05` `[reference]` `[browser]` —
...
- [x] `CB-OPEN-06` `[reference]` `[browser]` —
  **Combobox should apply programmatic open and close without emitting user callbacks.**
  ...
  intent.
- [x] `CB-OPEN-07` `[reference]` `[browser]` —
...
- [x] `CB-EDIT-01` `[vendor]` `[browser:all]` —
...
- [x] `CB-EDIT-03` `[reference]` `[browser]` —
...
- [x] `CB-EDIT-04` `[reference]` `[browser]` —
...
- [x] `CB-EDIT-07` `[reference]` `[browser]` —
...
- [x] `CB-EDIT-09` `[vendor]` `[browser:all]` —
...
- [x] `CB-NAV-01` `[vendor]` `[browser:all]` —
...
- [x] `CB-NAV-04` `[convergence]` `[browser]` —
...
- [x] `CB-NAV-05` `[convergence]` `[browser]` —
...
- [x] `CB-MODE-01` `[convergence]` `[browser]` —
...
- [x] `CB-MODE-03` `[convergence]` `[browser]` —
...
- [x] `CB-MODE-04` `[convergence]` `[browser]` —
  **Combobox autocomplete both should update completion across options and restore the typed prefix when none is active.**
  ...
  reversible.
- [x] `CB-MODE-05` `[reference]` `[browser]` —
...
- [x] `CB-MODE-06` `[reference]` `[browser]` —
  **Combobox should safely clear obsolete inline completion when autocomplete mode changes while open.**
  ...
  authoritative.
- [x] `CB-MODE-07` `[reference]` `[browser]` —
...
- [x] `CB-COMMIT-01` `[vendor]` `[browser:all]` —
...
- [x] `CB-COMMIT-05` `[reference]` `[browser]` —
...
- [x] `CB-REVERT-02` `[reference]` `[browser]` —
...
- [x] `CB-REVERT-03` `[convergence]` `[browser]` —
...
- [x] `CB-REVERT-04` `[reference]` `[browser]` —
...
- [x] `CB-REVERT-05` `[reference]` `[browser]` —
...
- [x] `CB-REVERT-06` `[reference]` `[browser]` —
...
- [x] `CB-REVERT-07` `[reference]` `[browser]` —
  **Combobox should preserve editing state on blur when closeOnBlur is false.**
  ...
  disable all closing.
- [x] `CB-CUSTOM-01` `[reference]` `[browser]` —
...
- [x] `CB-CUSTOM-02` `[reference]` `[browser]` —
...
- [x] `CB-SELECT-01` `[vendor]` `[browser]` —
  **Select-only Combobox should leave Trigger labeling to the application and activate the controlled selected option on open.**
  ...
  store.
- [x] `CB-SELECT-02` `[vendor]` `[browser:all]` —
...
- [x] `CB-SELECT-05` `[reference]` `[browser]` —
...
- [x] `CB-SELECT-06` `[reference]` `[browser]` —
...
- [x] `CB-SELECT-07` `[vendor]` `[browser]` —
  **Select-only Combobox should keep disabled sources and selected options out of active navigation.**
  ...
  behavior.
- [x] `CB-SELECT-08` `[vendor]` `[browser:all]` —
...
- [x] `CB-VIRT-01` `[reference]` `[browser]` —
...
- [x] `CB-VIRT-02` `[reference]` `[browser]` —
  **Combobox should cancel stale virtual targets during rapid navigation and filtering.**
  ...
  intent.
- [x] `CB-VIRT-03` `[reference]` `[browser]` —
...
- [x] `CB-TREE-01` `[reference]` `[browser]` —
...
- [x] `CB-ADAPTER-01` `[reference]` `[browser]` —
...
- [x] `CB-ADAPTER-02` `[reference]` `[browser]` —
...
- [x] `CB-ADAPTER-03` `[reference]` `[browser]` —
...
- [x] `CB-ADAPTER-04` `[reference]` `[browser]` —
...
- [x] `CB-ADAPTER-05` `[reference]` `[browser]` —
  **Combobox should diagnose invalid custom-grid metadata, navigation targets, and VirtualItem children before activation.**
  ...
  become interactive.
- [x] `CB-ADAPTER-06` `[reference]` `[browser:all]` —
...
- [x] `CB-ADAPTER-07` `[reference]` `[browser]` —
...
- [x] `CB-ADAPTER-08` `[reference]` `[browser]` —
...
- [x] `CB-CLOSE-01` `[reference]` `[browser]` —
...
- [x] `CB-CLOSE-02` `[reference]` `[browser]` —
...
- [x] `CB-CLOSE-03` `[reference]` `[browser]` —
...
- [x] `CB-CLOSE-04` `[reference]` `[browser]` —
...
- [x] `CB-ENV-02` `[reference]` `[react:all]` —
...
- [x] `CB-ENV-04` `[reference]` `[browser:all]` —
...
- [x] `CB-A11Y-01` `[reference]` `[browser]` —
...
- [x] `CB-COMP-01` `[reference]` `[browser]` —
...
- [x] `CB-COMP-02` `[reference]` `[browser]` —
...
- [x] `CB-COMP-03` `[reference]` `[browser]` —
