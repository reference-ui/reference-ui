...
- [x] `TT-HOVER-01` `[vendor]` `[browser:all]` —
...
- [x] `TT-HOVER-02` `[vendor]` `[browser:all]` —
...
- [x] `TT-HOVER-04` `[reference]` `[browser]` —
...
- [x] `TT-HOVER-05` `[vendor]` `[browser:all]` —
...
- [x] `TT-HOVER-08` `[vendor]` `[browser]` —
  **Tooltip should cancel delayed close when mouse leaves both regions but
  ...
  request occurs.
- [x] `TT-HOVER-09` `[reference]` `[browser]` —
...
- [x] `TT-HOVER-10` `[reference]` `[browser]` —
...
- [x] `TT-FOCUS-06` `[reference]` `[browser]` —
...
- [x] `TT-CLOSE-02` `[reference]` `[browser]` —
...
- [x] `TT-CLOSE-04` `[reference]` `[browser]` —
...
- [x] `TT-CLOSE-05` `[reference]` `[browser]` —
...
- [x] `TT-CLOSE-06` `[reference]` `[browser]` —
...
- [x] `TT-CLOSE-07` `[reference]` `[browser]` —
...
- [x] `TT-GROUP-05` `[reference]` `[browser]` —
...
- [x] `TT-GROUP-08` `[reference]` `[shadow]` —
...
- [x] `TT-GROUP-09` `[reference]` `[browser]` —
...
- [x] `TT-GROUP-10` `[reference]` `[browser]` —
...
- [x] `TT-SCROLL-04` `[reference]` `[shadow]` —
  **Tooltip should detect relevant ancestor scrolling when Trigger is reached
  ...
  retargeting.
- [x] `TT-POS-01` `[reference]` `[browser:all]` —
...
- [x] `TT-ENV-02` `[reference]` `[react:all]` —
...
- [x] `TT-ENV-03` `[reference]` `[browser:all]` —
...
- [x] `TT-A11Y-01` `[reference]` `[browser]` —
...
- [x] `TT-COMP-01` `[reference]` `[browser]` —
...
- [x] `TT-COMP-02` `[reference]` `[browser]` —
