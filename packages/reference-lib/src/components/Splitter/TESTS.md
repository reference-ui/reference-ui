...
- [x] `SP-DOM-04` `[convergence]` `[browser]` —
...
- [x] `SP-A11Y-01` `[reference]` `[browser]` —
...
- [x] `SP-CTRL-01` `[reference]` `[browser]` —
  **Splitter should request one complete normalized array when pointer or keyboard resize occurs.**
  ...
  object layout.
- [x] `SP-CTRL-02` `[reference]` `[browser]` —
...
- [x] `SP-CTRL-04` `[reference]` `[browser]` —
...
- [x] `SP-CTRL-05` `[reference]` `[browser]` —
  **Splitter should use current callbacks and constraints without rebasing origin layout when they change during a drag.**
  ...
  jump.
- [x] `SP-CTRL-06` `[reference]` `[browser]` —
...
- [x] `SP-END-01` `[vendor]` `[browser:all]` —
...
- [x] `SP-END-02` `[vendor]` `[browser:all]` —
...
- [x] `SP-DRAG-01` `[vendor]` `[browser:all]` —
...
- [x] `SP-DRAG-02` `[vendor]` `[browser:all]` —
...
- [x] `SP-DRAG-03` `[vendor]` `[browser:all]` —
...
- [x] `SP-DRAG-04` `[vendor]` `[browser:all]` —
...
- [x] `SP-DRAG-06` `[reference]` `[browser]` —
...
- [x] `SP-DRAG-10` `[reference]` `[browser]` —
...
- [x] `SP-KEY-01` `[vendor]` `[browser:all]` —
...
- [x] `SP-COLLAPSE-01` `[convergence]` `[browser]` —
  **Splitter should request collapsed size when Enter targets an expanded collapsible primary Panel.**
  ...
  behavior.
- [x] `SP-COLLAPSE-02` `[vendor]` `[browser]` —
...
- [x] `SP-COLLAPSE-03` `[reference]` `[browser]` —
...
- [x] `SP-COLLAPSE-04` `[reference]` `[browser]` —
...
- [x] `SP-COLLAPSE-05` `[reference]` `[browser]` —
...
- [x] `SP-COLLAPSE-06` `[reference]` `[browser]` —
...
- [x] `SP-COLLAPSE-07` `[reference]` `[unit]` —
...
- [x] `SP-DYNAMIC-01` `[vendor]` `[browser]` —
  **Splitter should preserve keyed metadata when Panels, Handles, and positional values change atomically.**
  ...
  mapping.
- [x] `SP-DYNAMIC-02` `[vendor]` `[browser]` —
...
- [x] `SP-DYNAMIC-03` `[reference]` `[browser]` —
...
- [x] `SP-ENV-02` `[reference]` `[react:all]` —
...
- [x] `SP-ENV-03` `[reference]` `[shadow]` —
  **Splitter should keep focus and global drag cleanup correct when rendered in a ShadowRoot.**
  ...
  group.
- [x] `SP-ENV-04` `[reference]` `[browser:all]` —
...
- [x] `SP-PERF-01` `[reference]` `[browser]` —
  **Splitter should not commit React on Panel descendants when pointermove updates layout.**
  ...
  not commit.
- [x] `SP-PERF-02` `[reference]` `[browser]` —
...
- [x] `SP-PERF-03` `[reference]` `[browser]` —
  **Splitter should not write separator ARIA on pointermove.**
  ...
  a 60 fps subscriber.
- [x] `SP-PERF-04` `[reference]` `[browser]` —
...
- [x] `SP-PERF-05` `[reference]` `[browser]` —
...
- [x] `SP-PERF-06` `[reference]` `[browser]` —
...
- [x] `SP-PERF-07` `[reference]` `[browser]` —
...
- [x] `SP-COMP-01` `[reference]` `[browser]` `[rtl]` —
  **Splitter should resize and restore a collapsible sidebar in a flex partition when direction is LTR or RTL.**
  ...
  `display: flex`.
- [x] `SP-COMP-02` `[reference]` `[browser]` —
  **Splitter should honor measured constraints when a vertical editor and console composition resizes.**
  ...
  no selection leak.
- [x] `SP-COMP-03` `[reference]` `[browser]` —
  **Splitter should isolate nested flex partitions when a three-Panel workspace contains an inner Splitter.**
  ...
  tree's descendants.
- [x] `SP-COMP-04` `[reference]` `[browser]` —
