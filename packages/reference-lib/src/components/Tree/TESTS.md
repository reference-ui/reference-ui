...
- [ ] `TR-SELECT-01` `[vendor]` `[browser:all]` —
...
- [ ] `TR-SELECT-02` `[reference]` `[browser]` —
...
- [ ] `TR-SELECT-03` `[reference]` `[browser]` —
...
- [ ] `TR-SELECT-04` `[reference]` `[browser]` —
...
- [ ] `TR-SELECT-07` `[reference]` `[browser]` —
...
- [ ] `TR-SELECT-08` `[reference]` `[browser]` —
...
- [ ] `TR-EXPAND-03` `[reference]` `[browser]` —
...
- [ ] `TR-EXPAND-04` `[vendor]` `[browser]` —
  **Tree should reveal and hide Groups from programmatic expansion updates without side effects.**
  ...
  hierarchy updates.
- [ ] `TR-EXPAND-05` `[reference]` `[browser]` —
...
- [ ] `TR-EXPAND-06` `[reference]` `[browser]` —
  **Tree should emit deterministic deduplicated expanded arrays in current traversal order.**
  ...
  relative order.
- [ ] `TR-EXPAND-07` `[reference]` `[browser]` —
...
- [ ] `TR-EXPAND-08` `[reference]` `[browser]` —
...
- [ ] `TR-EXPAND-09` `[reference]` `[browser]` —
...
- [ ] `TR-DYNAMIC-02` `[vendor]` `[unit]` —
  **Tree's hierarchy model should preserve value identity when moving a branch with descendants.**
  ...
  regression.
- [ ] `TR-DYNAMIC-03` `[reference]` `[browser]` —
...
- [ ] `TR-DYNAMIC-04` `[reference]` `[browser]` —
...
- [ ] `TR-COMP-01` `[reference]` `[browser]` `[rtl]` —
