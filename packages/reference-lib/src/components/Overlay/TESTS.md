...
Overlay owns the layer kernel: portal, one shared stack, controlled
dismissal, Presence, restore-after-exit, optional isolation (FocusLock,
inert, scroll lock), optional `Overlay.Trigger`, anchored Floating UI
geometry, and viewport-edge binding with Handle drag.
...
- [x] `OV-LAYER-06` `[convergence]` `[browser]` —
...
- [x] `OV-POINTER-01` `[vendor]` `[browser:all]` —
  **Overlay should block background pointer activation when a modal layer is
  ...
  with a pointer”).
- [x] `OV-POINTER-02` `[vendor]` `[browser]` —
...
- [x] `OV-POINTER-03` `[vendor]` `[browser]` —
...
- [x] `OV-POINTER-04` `[reference]` `[browser]` —
  **Overlay should make only the top modal Content interactive when layers
  ...
  dismiss both.
- [x] `OV-POINTER-05` `[reference]` `[browser]` —
...
- [x] `OV-POINTER-06` `[reference]` `[browser]` —
...
- [x] `OV-FOCUS-01` `[convergence]` `[browser:all]` —
...
- [x] `OV-FOCUS-02` `[reference]` `[browser]` —
...
- [x] `OV-FOCUS-03` `[vendor]` `[browser]` —
  **Overlay should skip only the initial focus move when
  ...
  focus.
- [x] `OV-FOCUS-04` `[vendor]` `[browser:all]` —
...
- [x] `OV-RESTORE-01` `[reference]` `[browser:all]` —
...
- [x] `OV-RESTORE-02` `[reference]` `[browser]` —
...
- [x] `OV-RESTORE-07` `[reference]` `[browser]` —
...
- [x] `OV-PRES-01` `[reference]` `[browser:all]` —
...
- [x] `OV-PRES-02` `[reference]` `[browser]` —
...
- [x] `OV-PRES-03` `[reference]` `[browser]` —
...
- [x] `OV-PRES-04` `[reference]` `[browser]` —
...
- [x] `OV-PRES-05` `[reference]` `[browser]` —
...
- [x] `OV-ENV-05` `[reference]` `[browser:all]` —
...
- [x] `OV-COMP-01` `[reference]` `[browser]` —
...
- [x] `OV-COMP-02` `[reference]` `[browser]` —
...
- [x] `OV-COMP-03` `[reference]` `[touch]` —
  **Overlay should maintain drawer isolation when an edge Drawer uses a
  ...
  only after exit.
- [x] `OV-COMP-04` `[reference]` `[browser]` —
