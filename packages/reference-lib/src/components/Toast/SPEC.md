...
- [ ] `TO-TIME-03` `[convergence]` `[browser]` —
...
- [ ] `TO-TIME-14` `[convergence]` `[browser]` —
...
- [ ] `TO-ENV-03` `[reference]` `[shadow]` —
  **Toast should keep visual and live DOM in an elected ShadowRoot when global
  ...
  normally.
- [ ] `TO-ENV-04` `[reference]` `[browser:all]` —
