...
export const Gate7 = () => <Gate7Fixture />
export const Gate7Dark = () => <Gate7Fixture theme="dark" />
export const Gate7Rich = () => <Gate7Fixture richColors />
export const Gate7Rtl = () => <Gate7Fixture dir="rtl" />
