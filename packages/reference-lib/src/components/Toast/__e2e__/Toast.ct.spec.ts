...
test.describe('Toast Composition Gates & Browser Proofs', () => {
  test('TO-DOM-01 & TO-DEF-01: Displays defined toast, updates content in place, and dismisses', async ({
    ...
    await mount('components/Toast/Toast/Basic')
    ...
    await snap(page, 'defined-toast-success')
    ...
    await page.waitForTimeout(300)
    await snap(page, 'defined-toast-updated')

    // Dismiss toast
    await page.getByTestId('btn-dismiss-toast').click()
    await expect(toastRoot).toHaveCount(0)
    await page.waitForTimeout(300)
    await snap(page, 'defined-toast-dismissed')
  })
  ...
  test('TO-DEF-DEFAULT: Displays default toast with title, description, and close button, and dismisses on close click', async ({
    ...
    await page.waitForTimeout(300)
    await snap(page, 'default-toast-open')
  ...
  test('TO-DEF-CUSTOM: Renders custom toast using toast.custom() and dismisses on close', async ({
    ...
    await page.waitForTimeout(300)
    await snap(page, 'custom-toast-open')
  ...
  test('TO-STACK-01: Correct card stacking order and transforms with newest toast in front', async ({
    ...
    await page.waitForTimeout(300)
    await snap(page, 'basic-stack-resting')
  ...
  test('TO-STACK-HOVER: Hovering over the stack expands out cards smoothly without flickering', async ({
    ...
    await expect(toasts).toHaveCount(3)
    await page.waitForTimeout(300)
    await snap(page, 'basic-stack-hover-expanded')
...
test.describe('Toast Gate 6', () => {
  test('TO-OV-01: Toast should pause visible timers when a modal Overlay becomes the top layer', async ({
    ...
    await mount('components/Toast/Toast/Gate6')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
    ...
    await page.waitForTimeout(300)
    await snap(page, 'gate6-modal-a-paused-toast')
  ...
  test('TO-HOTKEY-01: Toast should move focus into the toaster when the configured hotkey is pressed', async ({
    ...
    let focusedInHost = await page.evaluate(() => {
    ...
    if (!focusedInHost) {
      ...
      focusedInHost = await page.evaluate(() => {
        const host = document.querySelector('[data-reference-toast-host]')
        return Boolean(host && document.activeElement && host.contains(document.activeElement))
      })
    }
  ...
  test('TO-DISMISSIBLE-01: Toast should refuse swipe and close when dismissible is false', async ({
    ...
    await item.locator('[data-reference-toast-close]').click({ force: true })
    await expect(item).toBeVisible()
...
test('TO-HOTKEY-01 custom: Toast should honor a custom toaster hotkey', async ({ mount, page }) => {
  await mount('components/Toast/Toast/HotkeyCustom')
  await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
  await page.getByTestId('btn-show-hotkey-toast').click()
  await expect(page.locator('[data-reference-toast-id="hotkey"]')).toBeVisible()
...
test('TO-HOTKEY-01 suppress: Toast should not steal focus when the hotkey is disabled', async ({
  ...
  await mount('components/Toast/Toast/HotkeyOff')
  await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
  await page.getByTestId('btn-show-hotkey-toast').click()
  await expect(page.locator('[data-reference-toast-id="hotkey"]')).toBeVisible()
...
test.describe('Toast Gate 7', () => {
  test('TO-RIVAL-ENTER: A new toast should enter from off the stack axis, not appear in place', async ({
    ...
    await mount('components/Toast/Toast/Gate7')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
    ...
    const samples = await page.evaluate(() => {
      ;(window as any).__toastObs?.disconnect()
      return (window as unknown as { __toastEnter: Array<{ state: string | null; y: number; opacity: string }> }).__toastEnter
    })
  ...
  test('TO-RIVAL-STACK: Collapsed cards behind the front should read as a stack', async ({
    mount,
    page,
  }) => {
    await mount('components/Toast/Toast/Gate7')
    ...
    await page.waitForTimeout(300)
    await snap(page, 'gate7-stack-collapsed')
  })

  test('TO-RIVAL-EXPAND: Expand should separate cards by measured height plus gap', async ({
    mount,
    page,
  }) => {
    await mount('components/Toast/Toast/Gate7')
    ...
    await snap(page, 'gate7-stack-expanded')
  ...
  test('TO-RIVAL-CARD: The default toast should be a 356px card with Sonner type anatomy', async ({
    ...
    await page.waitForTimeout(300)
    await snap(page, 'gate7-card-resting')
  ...
  test('TO-RIVAL-ACTION: Action and cancel should be compact trailing buttons, and close unless prevented', async ({
    ...
    await page.waitForTimeout(300)
    await snap(page, 'gate7-action-cancel-buttons')
  ...
  test('TO-RIVAL-LOADER: Loading should use a spinner that crossfades when the type changes', async ({
    ...
    await page.waitForTimeout(300)
    await snap(page, 'gate7-loader-spinning')
    ...
    await page.waitForTimeout(300)
    await snap(page, 'gate7-loader-success')
  })
  ...
  test('TO-RIVAL-RICH: richColors should paint the card and its close button in type color', async ({
    ...
    await page.waitForTimeout(300)
    await snap(page, 'gate7-rich-colors')
  })
...
test('TO-RIVAL-THEME: The toaster should have an explicit light, dark, and system theme', async ({
  ...
  await page.waitForTimeout(300)
  await snap(page, 'gate7-theme-light')

  await mount('components/Toast/Toast/Gate7Dark')
  await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
  await page.getByTestId('btn-enter-bottom').click()
  ...
  await page.waitForTimeout(300)
  await snap(page, 'gate7-theme-dark')
  ...
  await page.waitForTimeout(300)
  await snap(page, 'gate7-theme-invert')
})
...
test('TO-RIVAL-OFFSET: Offset and mobile offset should place the stack, including on a narrow viewport', async ({
  ...
  await mount('components/Toast/Toast/Gate7Style')
  await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
...
test('TO-RIVAL-DIR: dir should flip chrome and the meaning of start and end', async ({ mount, page }) => {
  await mount('components/Toast/Toast/Gate7Rtl')
  await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
...
test('TO-RIVAL-STYLE: A toast should accept style, className, and unstyled without losing behavior', async ({
  ...
  await page.waitForTimeout(300)
  await snap(page, 'gate7-styled-custom')
  ...
  await page.waitForTimeout(300)
  await snap(page, 'gate7-unstyled')
})
...
test('TO-RIVAL-CLASSNAMES: Toaster and toast classNames should target the styled parts', async ({
  ...
  await page.waitForTimeout(300)
  await snap(page, 'gate7-classnames')
})
...
test.describe('Toast hardening', () => {
  test('TO-DOM-02: one stable stack per occupied position, empty stacks removed', async ({
    mount,
    page,
  }) => {
    ...
    await page.waitForTimeout(300)
    await snap(page, 'harden-positions-multiple')
  ...
  test('TO-DOM-03: item wrapper keeps identity through open then closed', async ({ mount, page }) => {
    await mount('components/Toast/Toast/Harden')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
  ...
  test('TO-DOM-04: arbitrary render output is left untouched', async ({ mount, page }) => {
    await mount('components/Toast/Toast/Harden')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
  ...
  test('TO-DEF-03 / TO-DEF-04: custom interactive JSX keeps native events', async ({ mount, page }) => {
    await mount('components/Toast/Toast/Harden')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
    ...
    await page.waitForTimeout(300)
    await snap(page, 'harden-interactive-input')
  ...
  test('TO-TIME-02: duration false stays open', async ({ mount, page }) => {
    await mount('components/Toast/Toast/Harden')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
  ...
  test('TO-TIME-03: duration 0 renders once then dismisses', async ({ mount, page }) => {
    await mount('components/Toast/Toast/Harden')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
  ...
  test('TO-TIME-01: timed toast remains until the deadline then dismisses', async ({ mount, page }) => {
    await mount('components/Toast/Toast/Harden')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
  ...
  test('TO-FOCUS-01: dismissing focused toast content restores the opener', async ({ mount, page }) => {
    await mount('components/Toast/Toast/Harden')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
  ...
  test('TO-FOCUS-02: invalid opener falls back to the nearest sibling', async ({ mount, page }) => {
    await mount('components/Toast/Toast/Harden')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
  ...
  test('TO-QUEUE-01 / TO-QUEUE-08: FIFO DOM order and dismiss-all clears the host', async ({
    mount,
    page,
  }) => {
    await mount('components/Toast/Toast/Harden')
  ...
  test('TO-COMP-01 / TO-COMP-02: custom timed notify and loading-to-complete identity', async ({
    mount,
    page,
  }) => {
    await mount('components/Toast/Toast/Harden')
  ...
  test('TO-TIME-05: resume exact remaining time when the pointer leaves', async ({ mount, page }) => {
    await mount('components/Toast/Toast/Harden')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
  ...
  test('TO-TIME-13: replacement duration stays paused until every pause source is gone', async ({
    mount,
    page,
  }) => {
    await mount('components/Toast/Toast/Harden')
  ...
  test('TO-TIME-14: keyboard focus pauses remaining time for that toast only', async ({ mount, page }) => {
    await mount('components/Toast/Toast/Harden')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
  ...
  test('TO-ENV-04: timeout, hover remainder, duration update, and same-frame recreate', async ({
    mount,
    page,
  }) => {
    await mount('components/Toast/Toast/Harden')
...
test.describe('Toast hardening limit', () => {
  test('TO-TIME-08: a waiting toast stays unmounted and untimed until promotion', async ({
    mount,
    page,
  }) => {
    await mount('components/Toast/Toast/HardenLimit')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
...
test.describe('Toast hardening premount', () => {
  test('TO-ANN-08: show and announce before mount replay once after activation', async ({
    mount,
    page,
  }) => {
    await mount('components/Toast/Toast/HardenPremount')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
...
test.describe('Toast hardening shadow', () => {
  test('TO-ENV-03: visual and live DOM stay inside the elected ShadowRoot', async ({ mount, page }) => {
...
test.describe('Toast hardening StrictMode', () => {
  test('TO-ENV-02 / TO-DEF-06: StrictMode replay keeps one lifecycle', async ({ mount, page }) => {
    await mount('components/Toast/Toast/HardenStrict')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
...
test.describe('Toast composition gate', () => {
  test('TO-COMP-03: nested modals pause a limited multi-position queue', async ({ mount, page }) => {
    await mount('components/Toast/Toast/Gate6')
    await expect(page.getByTestId('toast-fixture-root')).toBeVisible()
