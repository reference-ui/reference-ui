...
- [ ] `SD-POINTER-01` `[vendor]` `[browser:all]` —
...
- [ ] `SD-POINTER-02` `[reference]` `[browser]` —
...
- [ ] `SD-POINTER-03` `[vendor]` `[browser:all]` —
  **Slider should preserve the grab offset when a Thumb is pressed away from its center.**
  ...
  a vertical thumb.”
- [ ] `SD-POINTER-04` `[vendor]` `[browser:all]` —
...
- [ ] `SD-POINTER-05` `[vendor]` `[touch]` —
  **Slider should resize from one owned touchpoint when unrelated touches and scrolling occur.**
  ...
  the same touchpoint.”
- [ ] `SD-POINTER-06` `[reference]` `[browser]` —
...
- [ ] `SD-POINTER-09` `[reference]` `[browser]` —
...
- [ ] `SD-POINTER-11` `[reference]` `[browser]` —
...
- [ ] `SD-POINTER-12` `[vendor]` `[browser:all]` —
...
- [ ] `SD-DYNAMIC-01` `[reference]` `[browser]` —
...
- [ ] `SD-DYNAMIC-04` `[reference]` `[browser]` —
...
- [ ] `SD-ENV-03` `[reference]` `[shadow]` —
  **Slider should preserve focus, capture, RTL, and geometry when rendered in a ShadowRoot.**
  ...
  geometry.
- [ ] `SD-ENV-04` `[reference]` `[browser:all]` —
...
- [ ] `SD-COMP-01` `[reference]` `[browser]` —
  **Slider should preserve fractional precision when a horizontal scalar volume composition is used.**
  ...
  one scalar model.
- [ ] `SD-COMP-02` `[reference]` `[browser]` `[rtl]` —
