...
- [ ] `PT-CONTAINER-01` `[reference]` `[browser]` —
  **Portal should use an already resolved object ref when `container.current` holds an element.**
  ...
  body location.
- [ ] `PT-CONTAINER-02` `[reference]` `[browser]` —
...
- [ ] `PT-CONTAINER-03` `[reference]` `[browser]` —
...
- [ ] `PT-CONTAINER-04` `[reference]` `[browser]` —
...
- [ ] `PT-CONTAINER-05` `[reference]` `[browser]` —
...
- [ ] `PT-CONTAINER-06` `[reference]` `[browser]` —
...
- [ ] `PT-REACT-01` `[convergence]` `[react:all]` —
...
- [ ] `PT-REACT-02` `[convergence]` `[react:all]` —
...
- [ ] `PT-REACT-03` `[reference]` `[react:all]` —
  **Portal should preserve keyed child state when parents rerender without changing the destination.**
  ...
  ref/effect cleanup.
- [ ] `PT-REACT-04` `[reference]` `[react:all]` —
...
- [ ] `PT-REACT-05` `[reference]` `[react:all]` —
...
- [ ] `PT-ENV-04` `[convergence]` `[browser:all]` —
