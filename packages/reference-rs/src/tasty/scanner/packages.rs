...
mod tests {
    ...
    fn external_import_uses_types_exports_for_root_and_subpath() {
        ...
        let root_entry = resolve_external_import(root.path(), "fancy-lib")
            .expect("root entry should resolve");
    ...
    fn external_import_falls_back_to_installed_types_provider() {
        ...
        let resolved = resolve_external_import(root.path(), "json-schema")
            .expect("types provider should resolve");
