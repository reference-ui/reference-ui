...
| :--- | :--- | :--- | :--- | :--- |
| **`DUMP`** | Fragment Dump Ingestion & In-Memory Artefact | 5 | 1 | 4 |
| **`TOKEN`** | Token Dictionary & Value Normalization | 8 | 0 | 8 |
| **`FONT`** | Font Definitions & Face Rules | 4 | 0 | 4 |
| **`MOTION`** | Keyframes & Animation Steps | 3 | 0 | 3 |
| **`GLOBAL`** | Global CSS, Reset & Conditions | 4 | 0 | 4 |
| **`RECIPE`** | Declared Component & Slot Recipes | 4 | 0 | 4 |
| **`EXTEND`** | Upstream Definition Merge & Private Scoping | 5 | 0 | 5 |
| **`LAYER`** | Upstream CSS Layer Isolation | 4 | 0 | 4 |
| **`ASK`** | The Five Canonical Query Contracts | 6 | 0 | 6 |
| **Total** | | **43** | **1** | **42** |
...
| `BAS-DUMP-02` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
| `BAS-DUMP-03` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
| `BAS-DUMP-04` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
| `BAS-DUMP-05` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
| `BAS-TOKEN-01` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
| `BAS-TOKEN-02` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
| `BAS-TOKEN-03` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
| `BAS-TOKEN-04` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
...
| `BAS-TOKEN-07` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
| `BAS-TOKEN-08` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
...
| `BAS-MOTION-01` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
| `BAS-MOTION-02` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
| `BAS-MOTION-03` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
...
| `BAS-RECIPE-01` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
| `BAS-RECIPE-02` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
| `BAS-RECIPE-03` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
| `BAS-RECIPE-04` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
...
| `BAS-ASK-01` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
| `BAS-ASK-02` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
...
| `BAS-ASK-06` | `packages/reference-rs/modules/base-system/src/lib.rs` | none |
