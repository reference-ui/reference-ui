...
export type { CreateTastyApiOptions, TastyApi, TastyMember, TastySymbol } from '../js/index'
...
export function caseOutputDir(caseName: string) {
  return join(packageDir, 'tasty', 'tests', 'cases', caseName, 'output')
}

function caseSnapshotDir(caseName: string) {
  return join(packageDir, 'tasty', 'tests', 'cases', caseName, '__snapshots__')
}
