...
type StrictRadiusValue = RadiusToken | 'none' | 'inherit' | 'initial' | 'revert'
...
type StrictSpacingValue = SpacingToken | 0 | '0' | 'auto' | 'inherit'
...
export type SystemStyleObject = StrictSpacingProps<
