...
//! never write `.mt_2r` in these files. This is not a jsx factory, not a
//! patterns farm, and not Panda's `styled-system/` codegen. Language (Rust vs
//! TypeScript) is a later call; the *input* is the base system either way.
