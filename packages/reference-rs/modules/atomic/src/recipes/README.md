...
`${system}__${className}_c_...`). Runtime `recipe()` (authored TypeScript)
looks up the pre-composed combinations in `RecipeRuntimeTable`. It does
not re-walk style objects and it does not evaluate author JS at runtime.
