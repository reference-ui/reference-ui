...
once per member and keep static siblings. Entry 64 closes here:
concat keys (`['col'+'or']`) fold through the shared binary node under
the single-leaf rule — a multi-leaf concat is ambiguous and refuses.
