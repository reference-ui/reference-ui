...
import { analyze, analyzeDetailed } from '../js/index'
import type { AtlasDiagnostic } from '../js/index'
...
export default async function globalSetup() {
  if (process.argv.includes('--update-goldens')) {
    throw new Error('Atlas harness does not support --update-goldens. Output is regenerated on setup.')
  }
