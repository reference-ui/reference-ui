 ...
 * Atlas identifies which interface a component's props satisfy, and where that interface is declared.
 * Tasty consumes ComponentInterface to resolve the full member list, JSDoc, defaults, and optionality.
 */
