...
const PROVIDE_DEFINE_CONFIG = ['@reference-ui/cli', '@reference-ui/cli/config'] as const
 ...
 * When config bundles @reference-ui/cli or @reference-ui/cli/config as external, we provide defineConfig.
 *
