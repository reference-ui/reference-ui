...
### `packages/reference-cli/src/system/font`
...
### `packages/reference-cli/src/system/patterns`
...
### `packages/reference-cli/src/system/config`
...
`packages/reference-cli/src/system/config/runConfig.ts` should:
...
`packages/reference-cli/src/system/patterns` should:
